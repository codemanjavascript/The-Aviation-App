/*
 Tommy Wan
 5/5/2020
 This is the display page for distance calculations. Through database, calculations will be shown here
 */
package wansteam;
...
public class DistanceDisplay extends JFrame implements ActionListener
{
    //Colors
    ...
    public DistanceDisplay(String dbName, String tableName, String[] tableHeaders)
    {
        //Formatting the frame
        super("Distance Activity Log");
