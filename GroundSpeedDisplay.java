/*
 Tommy Wan
 7/19/2020
 This is the display page for groundspeed calculations. Through database, calculations will be shown here
 */
package wansteam;
...
public class GroundSpeedDisplay extends JFrame implements ActionListener
{
    //Colors
    ...
    public GroundSpeedDisplay(String dbName, String tableName, String[] tableHeaders)
    {
        //Formatting the frame
        super("Ground Speed Activity Log");
