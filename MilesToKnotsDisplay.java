/*
 Tommy Wan
 7/19/2020
 This is the display page for miles to knots calculations. Through database, calculations will be shown here
 */
package wansteam;
...
public class MilesToKnotsDisplay extends JFrame implements ActionListener
{
    //Colors
    ...
    public MilesToKnotsDisplay(String dbName, String tableName, String[] tableHeaders)
    {
        //Formatting the frame
        super("Miles To Knots Activity Log");
