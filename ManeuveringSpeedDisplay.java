/*
 Tommy Wan
 7/20/2020
 This is the display page for manuvering speed calculations. Through database, calculations will be shown here
*/
package wansteam;
...
public class ManeuveringSpeedDisplay extends JFrame implements ActionListener
{
    //Colors
    ...
    public ManeuveringSpeedDisplay(String dbName, String tableName, String[] tableHeaders)
    {
        //Formatting the frame
        super("Maneuvering Speed Activity Log");
