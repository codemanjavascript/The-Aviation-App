/*
 Tommy Wan
 7/19/2020
 This is the display page for CompassHeading calculations. Through database, calculations will be shown here
*/
package wansteam;
...
public class CompassHeadingDisplay extends JFrame implements ActionListener
{
    //Colors
    ...
    public CompassHeadingDisplay(String dbName, String tableName, String[] tableHeaders)
    {
        //Formatting the frame
        super("Compass Heading Activity Log");
